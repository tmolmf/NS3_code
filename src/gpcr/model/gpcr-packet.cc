...
NS_LOG_COMPONENT_DEFINE ("GpcrPacket");
...
TypeHeader::TypeHeader (MessageType t = GPCRTYPE_HELLO)
  : m_type (t),
    m_valid (true)
{
}
...
{
  static TypeId tid = TypeId ("ns3::gpcr::TypeHeader")
    .SetParent<Header> ()
...
// HELLO
//-----------------------------------------------------------------------------
  HelloHeader::HelloHeader (uint64_t originPosx, uint64_t originPosy, uint8_t isCoordinator, uint64_t ttm_mess)
...
{
  static TypeId tid = TypeId ("ns3::gpcr::HelloHeader")
    .SetParent<Header> ()
...
HelloHeader::Deserialize (Buffer::Iterator start)
{
  ...
  m_ttm_mess = i.ReadNtohU64 ();//added
...
{
  static TypeId tid = TypeId ("ns3::gpcr::PositionHeader")
    .SetParent<Header> ()
